...
// --------------------------------------------------
// 4. Alternar estado de la oferta
// --------------------------------------------------
$id = filter_input(INPUT_POST, 'id', FILTER_VALIDATE_INT);
if ($id) {
    $stmt = $pdo->prepare('UPDATE ofertas SET activo = 1 - activo WHERE id = :id');
    $stmt->execute([':id' => $id]);
}
...
// --------------------------------------------------
header('Location: /service/admin/ofertas.php?msg=toggle');
exit;
